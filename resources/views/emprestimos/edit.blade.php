...
<div class="d-flex cabecalho2">
	...
	<div class="collapse navbar-collapse flex-row-reverse" id="menuNavbar">
		<ul class="navbar-nav me-auto ">
			...
			<a class="nav-item nav-link active align-itens-center m-2" href="{{ route('emprestimos.index')}}">
				Voltar
			...
			<form action="{{ route('emprestimos.update', $Emprestimo->id) }}" method="POST" class="col-12 m-0 p-0 formulario">
				...
				<div class="row m-2">
					<div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
						...
						<input value="{{$Emprestimo->quantidadeemprestada}}" type="number" id="quantidadeemprestada" class="w-auto form-control w-sm-auto" placeholder="" name="quantidadeemprestada" required>
					</div>
					<div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
