...
<div class="container-fluid">
    ...
    <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
        ...
        <div class="row">
            <form action="{{ route('emprestimos.indexBuscar') }}" class="d-flex justify-content-around w-auto" method="GET">
                @csrf
                <div class="row">
                    <div style="display: flex;">
                        ...
                        <a href="{{ route('emprestimos.index') }}" class="btn btn-success m-2">Limpar Filtro</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal-dialog text-center">
        <div class="modal-content">
            <div class="modal-header"><!--Modal-header-->
                <h5 class="modal-title" id="exampleModalLabel">Excluir Emprestimo</h5>
            </div>
