...
@section('titulo','Lista de Entradas')
  ...
  <table class="table table-sm">
      ...
      <thead>
        <tr>
          <th scope="col">id</th>
          <th>datadatransferencia</th><br>
          <th>unidadeanterior</th>
          <th>centrodecustoanterior</th>
          <th>novaunidade</th>
          <th>centrodecustodestino</th>
          <th>usuario_id</th>
          ...
          <td>{{$entradas->nome}}</td>
             ...
             <td>
                   <form action="{{route('entradas.delete', ['id' => $entradas->id])}}" method="post">
                    @csrf
                    @method('DELETE')   
                ...
                <td>
                    <form action="{{route('entradas.edit', ['id' => $entradas->id])}}" method="post">
                        @csrf
     ...
     <form action="{{route('entradas.create')}}" method="post">
                        @csrf
                        <input type="submit" class="btn btn-primary" name="formulario" value="cadastrar nova entrada">
                    </form>
