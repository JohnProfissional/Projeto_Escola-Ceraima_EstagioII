...
<div class="container-fluid">
    <div class="ms-5 text-start badge text-wrap sinalizador">
        ...
        </svg> Cadastrar Entrada
    </div>

    <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
        <div class="row d-flex justify-content-around ">
            <form action="{{ route('entradas.store') }}" id="formEntrada" method="POST" class="col-12 m-0 p-0 formulario">
                @csrf

                <div class="row m-2">
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="datadatransferencia" class="m-2 textoAzul3">Data da Transferência:</label>
                        <input name="datadatransferencia" type="date" id="datadatransferencia" class="w-auto form-control w-sm-auto" placeholder="" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="unidadeanterior" class="m-2 textoAzul3">Unidade Anterior:</label>
                        <input type="text" id="unidadeanterior" class="w-auto form-control w-sm-auto" placeholder="" name="unidadeanterior" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="novaunidade" class="m-2 textoAzul3">Nova Unidade:</label>
                        <input type="text" id="novaunidade" class="w-auto form-control w-sm-auto" placeholder="" name="novaunidade" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="centrodecustoanterior" class="m-2 textoAzul3">Centro de Custo Anterior:</label>
                        <input type="text" id="centrodecustoanterior" class="w-auto form-control w-sm-auto" placeholder="" name="centrodecustoanterior" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="centrodecustodestino" class="m-2 textoAzul3">Centro de Custo Destino:</label>
                        <input type="text" id="centrodecustodestino" class="w-auto form-control w-sm-auto" placeholder="" name="centrodecustodestino" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="unidadeorcamentaria" class="m-2 textoAzul3">Unidade Orçamentária:</label>
                        <input type="text" id="unidadeorcamentaria" class="w-auto form-control w-sm-auto" placeholder="" name="unidadeorcamentaria" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="orgao" class="m-2 textoAzul3">Órgão:</label>
                        <input type="text" id="orgao" class="w-auto form-control w-sm-auto" placeholder="" name="orgao" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                    ...
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        ...
                        <input name="datadanotafiscal" type="date" id="datadanotafiscal" class="w-auto form-control w-sm-auto" placeholder="" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="valortotaldosbens" class="m-2 textoAzul3">Valor Total dos Bens:</label>
                        <input type="number" id="valortotaldosbens" class="w-auto form-control w-sm-auto" placeholder="" name="valortotaldosbens" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="totaldebens" class="m-2 textoAzul3">Total de Bens:</label>
                        <input name="totaldebens" value="0" type="number" id="totaldebens" class="w-auto form-control w-sm-auto" placeholder="" required>
                    </div>
                </div>
