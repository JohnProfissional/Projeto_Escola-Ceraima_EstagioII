            ...
            <form action="{{ route('entradas.update', $Entrada->id) }}" method="POST" class="col-12 m-0 p-0 formulario">
                ...
                <div class="row m-2">
                    ...
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        ...
                        <input value="{{$Entrada->numerodanotafiscal}}" type="text" id="numerodanotafiscal" class="w-auto form-control w-sm-auto" placeholder="" name="numerodanotafiscal" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
