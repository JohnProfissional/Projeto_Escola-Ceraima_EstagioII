...
<div class="container-fluid">
    ...
    <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
        <div class="row d-flex justify-content-around ">
            <form action="{{ route('entradas.update', $Entrada->id) }}" method="POST" class="col-12 m-0 p-0 formulario">
                @csrf

                <div class="row m-2">
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="datadatransferencia" class="m-2 textoAzul3">Data da Transferência:</label>
                        <input value="{{$Entrada->datadatransferencia}}" name="datadatransferencia" type="date" id="datadatransferencia" class="w-auto form-control w-sm-auto" placeholder="" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="unidadeanterior" class="m-2 textoAzul3">Unidade Anterior:</label>
                        <input value="{{$Entrada->unidadeanterior}}" type="text" id="unidadeanterior" class="w-auto form-control w-sm-auto" placeholder="" name="unidadeanterior" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="novaunidade" class="m-2 textoAzul3">Nova Unidade:</label>
                        <input value="{{$Entrada->novaunidade}}" type="text" id="novaunidade" class="w-auto form-control w-sm-auto" placeholder="" name="novaunidade" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="centrodecustoanterior" class="m-2 textoAzul3">Centro de Custo Anterior:</label>
                        <input value="{{$Entrada->centrodecustoanterior}}" type="text" id="centrodecustoanterior" class="w-auto form-control w-sm-auto" placeholder="" name="centrodecustoanterior" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="centrodecustodestino" class="m-2 textoAzul3">Centro de Custo Destino:</label>
                        <input value="{{$Entrada->centrodecustodestino}}" type="text" id="centrodecustodestino" class="w-auto form-control w-sm-auto" placeholder="" name="centrodecustodestino" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="unidadeorcamentaria" class="m-2 textoAzul3">Unidade Orçamentária:</label>
                        <input value="{{$Entrada->unidadeorcamentaria}}" type="text" id="unidadeorcamentaria" class="w-auto form-control w-sm-auto" placeholder="" name="unidadeorcamentaria" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="orgao" class="m-2 textoAzul3">Órgão:</label>
                        <input value="{{$Entrada->orgao}}" type="text" id="orgao" class="w-auto form-control w-sm-auto" placeholder="" name="orgao" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="numerodanotafiscal" class="m-2 textoAzul3">Número da Nota Fiscal:</label>
                        <input value="{{$Entrada->numerodanotafiscal}}" type="number" id="numerodanotafiscal" class="w-auto form-control w-sm-auto" placeholder="" name="numerodanotafiscal" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="datadanotafiscal" class="m-2 textoAzul3">Data da Nota Fiscal:</label>
                        <input value="{{$Entrada->datadanotafiscal}}" name="datadanotafiscal" type="date" id="datadanotafiscal" class="w-auto form-control w-sm-auto" placeholder="" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="valortotaldosbens" class="m-2 textoAzul3">Valor Total dos Bens:</label>
                        <input value="{{$Entrada->valortotaldosbens}}" type="number" id="valortotaldosbens" class="w-auto form-control w-sm-auto" placeholder="" name="valortotaldosbens" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="totaldebens" class="m-2 textoAzul3">Total de Bens:</label>
                        <input value="{{$Entrada->totaldebens}}" name="totaldebens" value="0" type="number" id="totaldebens" class="w-auto form-control w-sm-auto" placeholder="" required>
                    </div>
                </div>
