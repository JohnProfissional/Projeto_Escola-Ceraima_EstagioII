        ...
        <ul class="navbar-nav me-auto ">
            ...
            <li class="nav-item">
                <form action="/logout" method="POST">
                    @csrf
                    <a class="nav-item nav-link align-itens-center m-2" href="/logout" onclick="event.preventDefault(); this.closest('form').submit();">
                        Sair
        ...
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <a class="nav-link align-itens-left text-left mt-4 mb-4 ms-2 me-2 p-2 itens-menu-lateral" href="patrimonios/create">
