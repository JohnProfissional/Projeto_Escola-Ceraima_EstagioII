        ...
        <ul class="navbar-nav me-auto ">
            ...
            <li class="nav-item">
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <a class="nav-item nav-link align-itens-center m-2" href="{{ route('logout') }}" onclick="event.preventDefault(); this.closest('form').submit();">
                        Sair
...
<div class="container-fluid">
    <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
        <div class="row d-flex justify-content-around ">
            ...
            <div class="w-auto d-flex justify-content-center">
                <a class="m-2 itens-home-page text-center" href="{{ route('patrimonios.index')}}">
            ...
            <div class="w-auto d-flex justify-content-center">
                <a class="m-2 itens-home-page text-center" href="{{ route('reservas.index')}}">
            ...
            <div class="w-auto d-flex justify-content-center">
                <a class="m-2 itens-home-page text-center" href="{{ route('emprestimos.index')}}">
            ...
            <div class="w-auto d-flex justify-content-center">
                <a class="m-2 itens-home-page text-center" href="{{ route('devolucoes.index')}}">
            ...
            <div class="w-auto d-flex justify-content-center">
                <a class="m-2 itens-home-page text-center" href="{{ route('logout')}}">
