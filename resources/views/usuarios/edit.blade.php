...
<div class="d-flex cabecalho2">
	...
	<div class="collapse navbar-collapse flex-row-reverse" id="menuNavbar">
		<ul class="navbar-nav me-auto ">
			...
			<a class="nav-item nav-link active align-itens-center m-2" href="{{ route('usuarios.index')}}">
				Voltar
...
<div class="container-fluid">
	...
	<div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
		<div class="row d-flex justify-content-around ">
			<form action="{{ route('usuarios.update', $Usuario->id) }}" method="POST" class="col-12 m-0 p-0 formulario">
				@csrf
				@method('PUT')

				<div class="row m-2">
					<div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
						<label for="name" class="m-2 textoAzul3">Nome do Usuário</label>
						<input value="{{$Usuario->name}}" type="text" id="name" class="w-auto form-control w-sm-auto" required name="name">
					</div>
					<div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
					...
					<div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
						...
						<input value="{{$Usuario->cargo}}" name="cargo" type="text" id="cargo" class="w-auto form-control w-sm-auto" required>
					</div>
					<div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
					...
					<div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
						...
						<input value="{{$Usuario->password}}" name="senha" type="password" id="senha" class="w-auto form-control w-sm-auto" required readonly>
					</div>
					<div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        ...
                        <select name="access_level" id="access_level" class="w-auto form-control w-sm-auto" required>
                            ...
                            <option value="admin" {{ $Usuario->access_level === 'admin' ? 'selected' : '' }}>Administrador</option>
                            <option value="user" {{ $Usuario->access_level === 'user' ? 'selected' : '' }}>Usuário Padrão</option>
                        </select>
                    </div>
				</div>
