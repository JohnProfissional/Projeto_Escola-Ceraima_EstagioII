...
<div class="container-fluid">
	...
	<div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
		<div class="row d-flex justify-content-around ">
			<form action="/usuarios/update/{{$Usuario->id}}" method="POST" class="col-12 m-0 p-0 formulario">
				@csrf
				@method('PUT')

				<div class="row m-2">
					<div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
						<label for="nome" class="m-2 textoAzul3">Nome do Usuário</label>
						<input value="{{$Usuario->nome}}" type="text" id="nome" class="w-auto form-control w-sm-auto" placeholder="" name="nome">
					</div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
						<label for="cpf" class="m-2 textoAzul3">CPF</label>
						<input value="{{$Usuario->cpf}}" name="cpf" type="text" id="cpf" class="w-auto form-control w-sm-auto" placeholder="">
					</div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
						<label for="cargo" class="m-2 textoAzul3">Cargo</label>
						<input value="{{$Usuario->cargo}}" name="cargo" type="text" id="cargo" class="w-auto form-control w-sm-auto" placeholder="">
					</div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
						<label for="email" class="m-2 textoAzul3">Email</label>
						<input value="{{$Usuario->email}}" name="email" type="text" id="email" class="w-auto form-control w-sm-auto" placeholder="">
					</div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
						<label for="senha" class="m-2 textoAzul3">Senha</label>
						<input value="{{$Usuario->senha}}" name="senha" type="text" id="senha" class="w-auto form-control w-sm-auto" placeholder="">
					</div>										
				</div>
