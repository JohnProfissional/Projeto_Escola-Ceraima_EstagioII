...
@section('titulo','Cadastro de Bem excedente')
...
<!--t -->
    ...
    @endif
        ...
        <div class="row g-3">
            <div>
                <h4>Cadastro de Bens Excedentes</h4><br>
            </div>
             <form action="{{route('Baixa_Patrimonial.store')}}" method="post">
                <div class="col">
                        <label for="descricaodoexcedente">Descrição do excedente</label>
                        <input type="text" class="form-control" name="descricaodoexcedente" id="descricaodoexcedente"><br>
                        
                        <label for="observacoes">Observações</label>
                        <input type="text" class="form-control" name="observacoes" id="observacoes"><br>
                        
                        <label for="quantidadeexcedente">Quantidade excedente</label>
                        <input type="text" class="form-control" name="quantidadeexcedente" id="quantidadeexcedente"><br>
                        
                        <label for="usuario_id">Usuario_id</label>
                        <input type="text" class="form-control" name="usuario_id" id="usuario_id"><br>            
