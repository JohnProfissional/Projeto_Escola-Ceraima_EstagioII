...
@section('title', 'Cadastrar Bem Excedente')
...
<div class="container-fluid">
    <div class="ms-5 text-start badge text-wrap sinalizador">
        ...
        </svg> Cadastrar Bem Excedente
    </div>

    <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
        <div class="row d-flex justify-content-around ">
            <form action="{{ route('bensexcedentes.store') }}" method="POST" class="col-12 m-0 p-0 formulario">
                @csrf

                <div class="row m-2">
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="descricao" class="m-2 textoAzul3">Descrição:</label>
                        <textarea id="descricao" class="w-auto form-control w-sm-auto" placeholder="" name="descricao" required></textarea>
                    </div>

                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="observacoes" class="m-2 textoAzul3">Observações:</label>
                        <input type="text" id="observacoes" class="w-auto form-control w-sm-auto" placeholder="" name="observacoes" required>
                    </div>

                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="quantidadeexcedente" class="m-2 textoAzul3">Quantidade excedente:</label>
                        <input name="quantidadeexcedente" type="number" id="quantidadeexcedente" class="w-auto form-control w-sm-auto" placeholder="" required>
                    </div>
