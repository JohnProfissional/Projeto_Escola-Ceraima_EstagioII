...
<div class="d-flex cabecalho2">
	...
	<div class="collapse navbar-collapse flex-row-reverse" id="menuNavbar">
		<ul class="navbar-nav me-auto ">
			...
			<a class="nav-item nav-link active align-itens-center m-2" href="{{ route('reservas.index')}}">
				Voltar
...
<div class="container-fluid">
	...
	<div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
		<div class="row d-flex justify-content-around ">
			<form action="{{ route('reservas.update', $Reserva->id) }}" method="POST" class="col-12 m-0 p-0 formulario">
				@csrf
				@method('PUT')
				...
				<div class="row m-2">
					<div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
						...
						<input value="{{$Reserva->datareserva}}" type="date" id="datareserva" class="w-auto form-control w-sm-auto" placeholder="" name="datareserva" required>
					</div>
					<div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
						<label for="quantidadeitensreservados" class="m-2 textoAzul3">Quantidade de Itens Reservados:</label>
						<input value="{{$Reserva->quantidadeitensreservados}}" name="quantidadeitensreservados" type="number" id="quantidadeitensreservados" class="w-auto form-control w-sm-auto" placeholder="" required>
					</div>
					<div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
					...
					<div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
						...
						<select name="patrimonio_id" id="patrimonio_id" class="w-auto form-control w-sm-auto" required>
							...
							<option value="{{ $patrimonio->id }}" {{ $Reserva->patrimonio_id == $patrimonio->id ? 'selected' : '' }}>
