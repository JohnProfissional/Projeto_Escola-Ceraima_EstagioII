...
<div class="d-flex cabecalho2">
    ...
    <div class="collapse navbar-collapse flex-row-reverse" id="menuNavbar">
        <ul class="navbar-nav me-auto ">
            <a class="nav-item nav-link active align-itens-center m-2" href="home">
                Início
            ...
            <a class="nav-item nav-link align-itens-center m-2" href="perfil">
                Perfil
            ...
            <a class="nav-item nav-link align-itens-center m-2" href="login">
                Sair
        ...
        <div class="row d-flex justify-content-around ">
            <div class="w-auto d-flex justify-content-center m-5">
                ...
                <form action="" method="POST" class="col-12 m-0 p-0 formulario">
                    ...
                    @csrf()
                    <div class="row s-1">
                        <div class="col col-md-4 col-md-2 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                            <label for="inputDataNotaFiscal" class="m-2 textoAzul3">Data Prevista para reserva:</label>
                            <input name="dataNotaFiscal" type="date" id="inputDataNotaFiscal" class="w-auto form-control w-sm-auto" placeholder="01/01/2023">
                        </div>
                        <div class="col col-lg-8 col-md-2 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                            <label for="inputSetor" class="w-2 textoAzul3">Quantidade:</label>
                            <input name="setor" type="text" id="inputSetor" class="w-auto form-control w-sm-auto" placeholder="4">
                        </div>
                        <div class="col col-lg-3 col-md-6 col-sm-auto m-lg-7 m-md-4 m-sm-0">
                            <label for="inputOrgao" class="m-2 textoAzul3">Onde será utilizado:</label>
                            <input type="text" id="inputOrgao" class="w-auto form-control w-sm-auto" placeholder="Ministerio da educação, Ministério da saúde..." name="orgao">
                        </div>
                        <div class="col-lg-20" style="text-align:right">
                            <button class="btn btn-success me-8 mb-8" style="color: #fff;">
                                Alterar
                            </button>
                        </div>
                    </div>
