...
<div class="container-fluid p-4">
    ...
    <a href="" id="categorias" class=" text-start badge text-wrap sinalizador">
    ...
    <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
        ...
        <div class="row">
            ...
            <div class="col col-lg-5 col-md-3 ms-5 mb-4">
                ...
                <div class="p-3" id="detalhes">
                    <?php $numeropatrimonio = 69;
                    echo ($numeropatrimonio); ?>
                </div>
            </div>
            <div class="col col-lg-5 col-md-3 ms-5 mb-4">
            ...
            <div class="col col-lg-5 col-md-3 ms-5 mb-4">
                ...
                <div class="p-3" id="detalhes">
                    <?php $valortotaldosbens = 89;
                    echo ($valortotaldosbens); ?>
                </div>
            </div>
            <div class="col col-lg-5 col-md-3 ms-5 mb-4">
                <h4>Data de aquisição do patrimônio:</h4>
                <div class="p-3" id="detalhes">
                    <?php $dataaquisicao = 9239;
                    echo ($dataaquisicao); ?>
                </div>
            </div>
            <div class="col col-lg-5 col-md-3 ms-5 mb-4">
