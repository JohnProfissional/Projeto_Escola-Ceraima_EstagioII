...
<head>
	...
	<title>Lista de Patrimônios Inservíveis</title>
</head>
<body>
	<div id="header">
		<h1>@yield('titulo')</h1>
    ...
    <div class="card-body">
                ...
                @endif
    @section('titulo','Lista de Patrimônios Inservíveis')

    <h1>Patrimônios Inservíveis</h1>
        ...
        @foreach ($patrimonios_inserviveis as $patrimonio_inservivel)
            <thead>
                <tr>
                    ...
                    <td scope="row">{{$patrimonio_inservivel->id}}</td>
