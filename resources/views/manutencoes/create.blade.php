...
<div class="d-flex cabecalho2">
    ...
    <div class="collapse navbar-collapse flex-row-reverse" id="menuNavbar">
        <ul class="navbar-nav me-auto ">
            ...
            <a class="nav-item nav-link active align-itens-center m-2" href="{{ route('manutencoes.index')}}">
                Voltar
...
<div class="container-fluid">
    ...
    <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
        <div class="row d-flex justify-content-around ">
            <form action="{{ route('manutencoes.store') }}" method="POST" class="col-12 m-0 p-0 formulario">
                @csrf
                ...
                <div class="row m-2">
                    ...
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        ...
                        <input name="dataprevistadeentrega" type="date" id="dataprevistadeentrega" class="w-auto form-control w-sm-auto" placeholder="" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="totaldasaidadebens" class="m-2 textoAzul3">Total da saída</label>
                        <input name="totaldasaidadebens" type="number" id="totaldasaidadebens" class="w-auto form-control w-sm-auto" placeholder="" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="dataentrada" class="m-2 textoAzul3">Data Entrada</label>
                        <input name="dataentrada" type="date" id="dataentrada" class="w-auto form-control w-sm-auto" placeholder="" required>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
