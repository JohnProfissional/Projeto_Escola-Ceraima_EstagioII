...
<div class="container-fluid">
	<div class="ms-5 text-start badge text-wrap sinalizador">
		...
		</svg> Editar Manutenção
	</div>

	<div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
		<div class="row d-flex justify-content-around ">
			<form action="{{ route('manutencoes.update', $Manutencao->id) }}" method="POST" class="col-12 m-0 p-0 formulario">
				@csrf
				@method('PUT')
				...
				<div class="row m-2">
					...
					<div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
						...
						<select name="patrimonio_id" id="patrimonio_id" class="w-auto form-control w-sm-auto" required>
							...
							<option value="{{ $patrimonio->id }}" {{ $Manutencao->patrimonio_id == $patrimonio->id ? 'selected' : '' }}>
					...
					<div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
						...
						<input value="{{$Manutencao->datasaida}}" name="datasaida" type="date" id="datasaida" class="w-auto form-control w-sm-auto" placeholder="">
					</div>
				</div>
