...
<div class="container-fluid">
    ...
    <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
        <div class="row d-flex justify-content-around ">
            <form action="/setores/update/{{$Setor->id}}" method="POST" class="col-12 m-0 p-0 formulario">
                @csrf

                <div class="row m-2">
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="descricaodosetor" class="m-2 textoAzul3">Descrição do Setor:</label>
                        <input value="{{$Setor->descricaodosetor}}" type="text" id="descricaodosetor" class="w-auto form-control w-sm-auto" placeholder="" name="descricaodosetor">
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="quantidadedecomodos" class="m-2 textoAzul3">Quantidade de cômodos:</label>
                        <input value="{{$Setor->quantidadedecomodos}}" name="quantidadedecomodos" type="number" id="quantidadedecomodos" class="w-auto form-control w-sm-auto" placeholder="">
                    </div>
                </div>
