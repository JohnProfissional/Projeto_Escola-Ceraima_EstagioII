...
<div class="container-fluid">
    ...
    <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
        ...
        <div class="row">
            <form action="{{ route('setores.indexBuscar') }}" class="d-flex justify-content-around w-auto" method="GET">
                @csrf
                <div class="row">
                    <div style="display: flex;">
                        ...
                        <a href="{{ route('setores.index') }}" class="btn btn-success m-2">Limpar Filtro</a>
                    </div>
                </div>
            </form>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col" id="meio">
                                <form action="{{route('setores.edit', ['id' => $setor->id])}}" method="get">
                                    @csrf
                        ...
                        <td>
                            <div class="col" id="meio">
                                <form id="formExcluir" action="{{ route('setores.delete', ['id' => $setor->id]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <td>
                            <div class="col" id="meio">
                                <form id="formShow" action="{{ route('setores.show', ['id' => $setor->id]) }}" method="GET">
                                    @csrf
