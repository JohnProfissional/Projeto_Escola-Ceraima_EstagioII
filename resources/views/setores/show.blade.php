...
@section('title', 'Visualizar Cômodo')
...
<div class="d-flex cabecalho2">
    ...
    <div class="collapse navbar-collapse flex-row-reverse" id="menuNavbar">
        <ul class="navbar-nav me-auto ">
            ...
            <a class="nav-item nav-link active align-itens-center m-2" href="{{ route('setores.index')}}">
                Voltar
            ...
            <form action="" method="POST" class="col-12 m-0 p-0 formulario">
                ...
                <div class="row m-2">
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        ...
                        <input value="{{$setores->id}}" type="number" id="id" class="w-auto form-control w-sm-auto" name="id" required readonly>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="quantidadedebens" class="m-2 textoAzul3">Quantidade de Cômodos:</label>
                        <input value="{{$setores->quantidadedecomodos}}" name="quantidadedebens" type="number" id="quantidadedebens" class="w-auto form-control w-sm-auto" placeholder="" required readonly>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="setor_id" class="m-2 textoAzul3">Setor:</label>
                        <input value="{{$setores->descricaodosetor }}" name="setor_id" type="text" id="setor_id" class="w-auto form-control w-sm-auto" placeholder="" required readonly>
                    </div>
                </div>
            </form>
        </div>
                ...
                <table class="table cabecalho-itens text-center p-2" id="conteudo-itens-lado-direito">
                    ...
                    <tbody class="conteudo-itens">
                        <tr>
                            ...
                            <td>{{$comodo->descricaodocomodo}}</td>
                            <td>{{$comodo->acessarSetor->descricaodosetor}}</td>

                            @can('access')
                            <td>
                                <div class="col" id="meio">
                                    <form action="{{route('comodos.edit', ['id' => $comodo->id])}}" method="get">
                                        @csrf
                            ...
                            <td>
                                <div class="col" id="meio">
                                    <form id="formExcluir" action="{{ route('comodos.delete', ['id' => $comodo->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                            ...
                            <td>
                                <div class="col" id="meio">
                                    <form action="{{route('comodos.show', ['id' => $comodo->id])}}" method="get">
                                        @csrf
                                        <input type="submit" class="btn btn-primary" name="formulario" value="Ver Detalhes">
                                    </form>
                                </div>
                            </td>
                        </tr>
