...
<div class="container-fluid">
    ...
    <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
        ...
        <div class="row">
            <form action="{{ route('comodos.indexBuscar') }}" class="d-flex justify-content-around w-auto" method="GET">
                @csrf
                <div class="row">
                    <div style="display: flex;">
                        ...
                        <a href="{{ route('comodos.index') }}" class="btn btn-success m-2">Limpar Filtro</a>
                    </div>
                </div>
            </form>
        </div>
            ...
            <table class="table cabecalho-itens text-center p-2" id="conteudo-itens-lado-direito">
                ...
                <tbody class="conteudo-itens">
                    <tr>
                        ...
                        <td>
                            <div class="col" id="meio">
                                <form id="formShow" action="{{ route('comodos.show', ['id' => $comodo->id]) }}" method="GET">
                                    @csrf
                                    <input type="submit" class="btn btn-primary" value="Ver Detalhes"><br><br>
                                </form>
                            </div>
                        </td>
                    </tr>
