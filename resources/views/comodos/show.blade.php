...
<div class="d-flex cabecalho2">
    ...
    <div class="collapse navbar-collapse flex-row-reverse" id="menuNavbar">
        <ul class="navbar-nav me-auto ">
            ...
            <a class="nav-item nav-link active align-itens-center m-2" href="{{ route('comodos.index')}}">
                Voltar
            ...
            <form action="" method="POST" class="col-12 m-0 p-0 formulario">
                ...
                <div class="row m-2">
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        ...
                        <input value="{{$comodos->id}}" type="number" id="id" class="w-auto form-control w-sm-auto" name="id" required readonly>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="quantidadedebens" class="m-2 textoAzul3">Quantidade de bens:</label>
                        <input value="{{$comodos->quantidadedebens}}" name="quantidadedebens" type="number" id="quantidadedebens" class="w-auto form-control w-sm-auto" placeholder="" required readonly>
                    </div>
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="setor_id" class="m-2 textoAzul3">Setor:</label>
                        <input value="{{$comodos->acessarSetor->descricaodosetor }}" name="setor_id" type="text" id="setor_id" class="w-auto form-control w-sm-auto" placeholder="" required readonly>
                    </div>
                </div>
            </form>
        </div>
