...
Route::prefix('patrimonios')->group(function () {
    ...
    Route::get('/createpatrientrada/{id}',[PatrimonioController::class,'createpatrientrada'])->middleware(['auth'])->name('patrimonios.createpatrientrada')->middleware('can:access');
    Route::post('/storepatrientrada',[PatrimonioController::class,'storepatrientrada'])->middleware(['auth'])->name('patrimonios.storepatrientrada')->middleware('can:access');
});
